...
export const GET = async (req) => {
    try {
        ...
        return NextResponse.json({error: 'مشگلی در دریافت آدرس ها رخ داده است'}, {status: 500});
    }
}
...
export async function POST(req) {
    ...
    try {
        ...
        return NextResponse.json({error: 'خطایی در افزودن آدرس رخ داده است'}, {status: 500});
    }
}
