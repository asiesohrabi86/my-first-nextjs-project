...
const AddUser = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error("مشگلی در ثبت کاربر پیش آمده است");
                
            }
            router.push('/admin/users?msg=کاربر با موفقیت ثبت شد');
        } catch (error) {
                    ...
                    <Col md="10">
                        ...
                        <main className='p-4'>
                            ...
                            <Form onSubmit={handleSubmit}>
                                ...
                                <Form.Group className='mb-3'>
                                    <Form.Check className='d-inline me-2' ref={isAdminInput} checked={isAdmin} onChange={(e)=>setIsAdmin(!isAdmin)} type='checkbox'/>
