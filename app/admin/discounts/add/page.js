...
const AddDiscount = () => {
    ...
    const validateForm = () => {
        ...
        if (typeof isActive != 'boolean' ) {
            setFormError("وضعیت تخفیف نامعتبر است");
            return false;
        }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error("مشگلی در ثبت کد تخفیف پیش آمده است");
                
            }
            router.push('/admin/discounts?msg=کد تخفیف با موفقیت ثبت شد');
        } catch (error) {
            ...
            <Container fluid>
                <Row>
                    ...
                    <Col md="10">
                        <Header/>
                        <main className='p-4'>
                            <h2 className='my-4'>ایجاد کد تخفیف </h2>
                            {/* logical error */}
                            ...
                            <Form onSubmit={handleSubmit}>
                                ...
                                <Form.Group className='mb-3'>
                                    ...
                                    <DatePicker value={expirationDate} calendar={persian} locale={persian_fa} format="HH:mm:ss  YYYY/MM/DD" onChange={setExpirationDate} placeholder='تاریخ انقضا را انتخاب کنید' required/>
                                </Form.Group>
                                <Form.Group className='mb-3'>
